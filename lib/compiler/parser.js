function parser(tokens) {
    ...
    function walk() {
      ...
      if (token.type === 'keyword' && token.value === 'return') {
        ...
        // Handle binary expression after return
        let nextToken = tokens[current];
      ...
      if (token.type === 'name') {
        ...
        if (nextToken && nextToken.type === 'paren' && nextToken.value === '(') {
          ...
          // Process arguments until we hit closing paren
          while (current < tokens.length && 
            ...
            if (tokens[current] && tokens[current].type === 'punctuation' && tokens[current].value === ',') {
